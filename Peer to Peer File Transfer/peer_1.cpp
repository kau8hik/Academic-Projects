...
#define tcp_port "31728"
#define static_tcp_port 31728
using namespace std;
...
int main(){	
	...
	cout<<"\nPeer1 Phase 1: The dynamic UDP port number "<<ntohs(cli.sin_port)<<" and IP address "<<ipaddr1<<endl; //dynamic port 0
	
     	myfile.close();
	//cout<<"username"<<username<<endl;
	cout<<"Peer1"<<" Phase 1: Sending the authentication information to the server < "<<username<<" >"<<endl;
	...
	string se="Peer1 "+(string) ipaddr1+" "+(string) tcp_port+" "+machine1;	// compiling message <username, ipaddress, tcp port, windows/mac>
	char send_ch[100];strcpy(send_ch,se.c_str());	

	if(strcmp(recvline,"success")==0){
		cout<<"Peer1"<<" Phase 1: Authentication successful\n";
		cout<<"Peer1"<<" Phase 1: Sending the file transfer information to the server < "<<send_ch <<" >"<<endl;
		...
		if(recvline1[0]=='w')cout<<user<<" Phase 1: Information received by the server\n";
	} 
	else {
		cout<<"Peer1 Phase 1: Authentication failed\n";
		cout<<"Peer1 Phase 1: End of Phase 1\n";
	...
	cout<<"Peer1 Phase 3: The Peer1 has static TCP port number "<<static_tcp_port<<" and IP address "<<ipaddr1<<endl;
	...
	char from[10];int m=0,fr=0;
		...
		cout<<"Peer1 Phase 3: Received the file from " <<from<<endl;
		...
		for_print[ik]='\0';
		cout<<"Peer1 Phase 3: The contents of the file are as follows: "<<endl;
		...
		if(n>5)
		{
			...
			cout<<"\nPeer1 Phase 3: The peer has dynamic TCP port number "<<ntohs(tcp_client.sin_port)<<" and IP address "<<ipaddr1<<endl;
			cout<<"Peer1 Phase 3: Sending file to "<<peer_no<<" having IP address "<<ipaddr<<" and static TCP port number "<<p<<endl;
			...
			if(j<5){
				...
				char mesg_se1[m_s+6];
				mesg_se1[0]='P';mesg_se1[1]='e';mesg_se1[2]='e';mesg_se1[3]='r';mesg_se1[4]='1';mesg_se1[5]=' ';
			...
			//cout<<"N:"<<n<<endl;
			if(rec3[0]=='h')
   			cout<<"Peer1 Phase 3: File transfer successful"<<endl;
			
      			//fputs(rec3,stdout);*/
			
		}
         	close(sockfd1);
		cout<<"Peer1 Phase 3: End of Phase 3\n";
      	}
